...
return [
    ...
    'custom' => [
        'customerPhone' => [
            'regex' => 'يجب أن يبدأ رقم الواتساب بالرقم 7 ويتكون من 9 أرقام بالكامل.',
        ],
        'link' => [
            'regex' => 'لا يمكن أن يحتوي رابط المنتج على حروف عربية.',
        ],
    ],
    ...
    'attributes' => [
        ...
        'customerPhone' => 'رقم واتساب',
        'itemName' => 'الوصف',
        'itemLink' => 'الرابط أو الكود',
        'itemQuantity' => 'الكمية',
        'itemDate' => 'التاريخ',
        'editCartName' => 'اسم السلة',
        'editDescription' => 'الوصف',
        'editCustomerPhone' => 'رقم واتساب العميل',
        'defaultCartName' => 'اسم السلة الافتراضي',
    ],
];
