...
<div class="mx-auto max-w-md p-6 sm:p-8">
    @if ($matches)
        <div class="rounded-2xl border border-line-medium bg-white p-5 shadow-sm sm:p-6">
            <h2 class="text-lg font-bold tracking-tight text-ink">وجدنا أكثر من طلب</h2>
            <p class="mt-0.5 text-xs text-muted">اختر الطلب الذي تريد تتبعه</p>
    ...
    @else
        <div class="rounded-2xl border border-line-medium bg-white p-5 shadow-sm sm:p-6">
            ...
            <p class="mt-0.5 text-xs text-muted">أدخل رقم هاتفك لعرض حالة طلبك</p>
